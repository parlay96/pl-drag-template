...
<template>
  <div class="components-contrl-bar">
    ...
    <div class="button-item" v-if="false" :class="{disabled: !canRedo}" @click="editorRedo">
      <i class="iconfont iconredo1"></i>
      <p>重做</p>
    </div>
    <div class="button-item" v-if="false" @click="showPreview">
      <i class="iconfont iconyulan"></i>
      <p>预览</p>
    </div>
    <UploadPsd @upload-success="uploadSuccessPsd" v-if="false">
      <div class="button-item">
    ...
    <div class="button-item" @click="publishFn" v-if="false">
